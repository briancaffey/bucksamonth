...
class Review(models.Model):
	reviewed_service 		= models.ForeignKey(Service, on_delete=models.CASCADE)
	review_user 			= models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name="review_user")
